...
BOT_URL = "https://magicpin-ai-challenge-67jm.onrender.com"

# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
LLM_PROVIDER = os.getenv("LLM_PROVIDER", "groq")

# Your API key — paste below OR set env var (recommended): GEMINI_API_KEY, OPENAI_API_KEY, etc.
LLM_API_KEY = os.getenv("LLM_API_KEY", "")

# Model (empty = provider default). Examples:
...
# Resolve API key from env if not set in CONFIGURATION (avoids committing secrets)
_ENV_KEY_MAP = {
...
if not LLM_API_KEY and LLM_PROVIDER in _ENV_KEY_MAP:
    LLM_API_KEY = os.getenv(_ENV_KEY_MAP[LLM_PROVIDER], "")
if not LLM_MODEL:
    _DEFAULT_MODELS = {
        "openai": "gpt-4o-mini",
        "anthropic": "claude-3-5-sonnet-20241022",
    ...
    LLM_MODEL = _DEFAULT_MODELS.get(LLM_PROVIDER, "")
    ...
    def complete(self, prompt: str, system: str = None) -> str:
        ...
        req = urlrequest.Request(
            ...
            headers={
                ...
                "User-Agent": "magicpin-ai-judge/1.0"
            }
        )
